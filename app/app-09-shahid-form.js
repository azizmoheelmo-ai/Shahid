...
async function saveShahid(){
  ...
  try{
    ...
    /* لا نعيد تفعيل الزر إلا هنا (عند الفشل) — عند النجاح نتركه معطَّلاً
       عمدًا حتى ينتقل المستخدم فعليًا للشاشة التالية (بعد 700-900ms أعلاه):
       لو أعدنا تفعيله فورًا كما كان سابقًا، تبقى نافذة زمنية قصيرة والنموذج
       لا يزال ظاهرًا بنفس بياناته — نقرة "حفظ" ثانية خلالها (خصوصًا لو تأخر
       الانتقال أو لم يلاحظ المستخدم رسالة النجاح) تُنشئ شاهدًا مكررًا. */
