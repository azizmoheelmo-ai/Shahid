...
const ELEMENT_META = {
  ...
  /* العناصر الثلاثة الأولى (أداء الواجبات الوظيفية / التفاعل مع المجتمع
     المهني / التفاعل مع أولياء الأمور) مشتركة بين كل شاغلي الوظائف
     التعليمية بالمدرسة (معلم، وكيل، مدير، موجه طلابي، محضر مختبر) وفق
     التفسير الرسمي الموحّد لها. عناصر المعلم نفسها (أعلاه) تبقى كما هي؛
     المدخلات التالية توفّر نفس الإرشاد لبقية الأدوار بمفاتيحها الخاصة،
     مصاغًا بما يناسب طبيعة كل دور دون تغيير جوهر التفسير المشترك. */
  "وكيل: أداء الواجبات الوظيفية": {
    "example": "توثيق التزامك كوكيل مدرسة بتطبيق الأنظمة الإدارية، وحماية خصوصية بيانات المعلمين والطلبة، والامتثال للتعاميم واللوائح المعتمدة.",
    "heading": "وصف الإجراء / الالتزام الوظيفي",
    "placeholder": "مثال: طبّقت تعليمات إدارة المدرسة بخصوص حفظ سجلات الطلبة وبياناتهم بسرية تامة، وامتثلت للتعاميم الوزارية المتعلقة بجدولة الاختبارات.",
    "goal": "مثال: ضمان تنفيذ المهام الإدارية المسندة إليّ بدقة، وحماية خصوصية بيانات منسوبي المدرسة.",
    "quant": "مثال: نسبة إنجاز المعاملات الإدارية في وقتها 100% خلال الفصل الدراسي.",
    "qual": "مثال: لم تُسجَّل أي شكوى تتعلق بتسريب بيانات أو تأخير معاملة إدارية.",
    "reflection": "هل التزمت بكل الأنظمة والتعاميم المعمول بها؟ وما الذي يمكن تحسينه بإجراءاتي الإدارية؟"
  },
  "وكيل: التفاعل مع المجتمع المهني": {
    "example": "توثيق مشاركتك كوكيل مدرسة في اجتماعات الوكلاء أو مجتمعات التطوير الإداري، وتبادل الخبرات الإدارية مع مدارس أخرى.",
    "heading": "وصف المشاركة المهنية",
    "placeholder": "مثال: شاركت في اجتماع وكلاء المدارس بالإدارة التعليمية وعرضت تجربة مدرستي في تنظيم الجدول الدراسي.",
    "goal": "مثال: تعزيز تبادل الخبرات الإدارية بين المدارس ونشر ممارسات إدارية فعالة.",
    "quant": "مثال: حضر اللقاء 10 من وكلاء المدارس المجاورة.",
    "qual": "مثال: أبدى الحضور اهتمامًا بتجربتي وطلبوا نسخة من الآلية المتبعة.",
    "reflection": "هل أسهمت مشاركتي في تطوير ممارسات إدارية بمدارس أخرى؟"
  },
  "وكيل: التفاعل مع أولياء الأمور": {
    "example": "توثيق تواصلك كوكيل مدرسة مع أولياء الأمور حول قرارات إدارية تخص أبناءهم (تحويل، انضباط، إجراء إداري).",
    "heading": "وصف التواصل مع أولياء الأمور",
    "placeholder": "مثال: تواصلت مع ولي أمر طالب محوَّل إداريًا لتوضيح الإجراء والاستماع لملاحظاته.",
    "goal": "مثال: ضمان وضوح القرارات الإدارية لأولياء الأمور وبناء شراكة فعالة معهم.",
    "quant": "مثال: تم التواصل مع 8 من أولياء الأمور خلال الشهر بخصوص إجراءات إدارية.",
    "qual": "مثال: تفهّم أولياء الأمور الإجراء ولم ترد أي شكوى بخصوصه.",
    "reflection": "هل كان أسلوب التواصل واضحًا ومطمئنًا لأولياء الأمور؟"
  },

  "مدير: أداء الواجبات الوظيفية": {
    "example": "توثيق التزامك كمدير مدرسة بتطبيق الأنظمة الإدارية والتربوية، وحماية خصوصية بيانات المدرسة، والامتثال للأدلة واللوائح الوزارية.",
    "heading": "وصف الإجراء / الالتزام الوظيفي",
    "placeholder": "مثال: طبّقت دليل العمل المدرسي بخصوص إدارة السجلات والصلاحيات، وامتثلت لتعليمات الإدارة التعليمية دون تأخير.",
    "goal": "مثال: ضمان انضباط العمل المدرسي وفق الأنظمة المعتمدة، وحماية بيانات المدرسة ومنسوبيها.",
    "quant": "مثال: نسبة الامتثال للتعاميم في وقتها 100% خلال الفصل الدراسي.",
    "qual": "مثال: لم تُسجَّل أي ملاحظة إشرافية على الالتزام الوظيفي خلال الزيارة الميدانية.",
    "reflection": "هل الأنظمة الإدارية مطبَّقة بانضباط كافٍ بمدرستي؟"
  },
  "مدير: التفاعل مع المجتمع المهني": {
    "example": "توثيق مشاركتك كمدير مدرسة في اجتماعات مديري المدارس أو المجالس القيادية، وتبادل الخبرات الإدارية والتربوية.",
    "heading": "وصف المشاركة المهنية",
    "placeholder": "مثال: شاركت في اجتماع مديري مدارس المكتب وعرضت تجربة مدرستي في رفع نتائج التحصيل.",
    "goal": "مثال: تعزيز تبادل الخبرات القيادية بين المدارس ونشر ممارسات إدارية وتربوية ناجحة.",
    "quant": "مثال: حضر الاجتماع 15 مديرًا ومديرة.",
    "qual": "مثال: طلب عدد من الحضور نسخة من التجربة لتطبيقها بمدارسهم.",
    "reflection": "هل أسهمت مشاركتي فعليًا في تطوير ممارسات بمدارس أخرى؟"
  },
  "مدير: التفاعل مع أولياء الأمور": {
    "example": "توثيق تواصلك كمدير مدرسة مع أولياء الأمور حول القرارات المدرسية العامة أو ملفات محددة تخص أبناءهم.",
    "heading": "وصف التواصل مع أولياء الأمور",
    "placeholder": "مثال: عقدت لقاءً مع مجلس أولياء الأمور لمناقشة خطة المدرسة للفصل الدراسي والاستماع لملاحظاتهم.",
    "goal": "مثال: بناء شراكة فعالة بين المدرسة وأولياء الأمور تخدم مصلحة الطلبة.",
    "quant": "مثال: حضر اللقاء 20 من أعضاء مجلس أولياء الأمور.",
    "qual": "مثال: طُرحت مقترحات بنّاءة تم اعتماد جزء منها بخطة المدرسة.",
    "reflection": "هل استمعت فعليًا لملاحظات أولياء الأمور وأخذتها بالاعتبار؟"
  },

  "موجه: أداء الواجبات الوظيفية": {
    "example": "توثيق التزامك كموجه طلابي بتطبيق الأنظمة وأخلاقيات المهنة، والحفاظ على سرية الحالات الطلابية وفق اللوائح.",
    "heading": "وصف الإجراء / الالتزام الوظيفي",
    "placeholder": "مثال: التزمت بسرية ملفات الحالات الطلابية، وطبّقت دليل التوجيه الطلابي في تصنيف الحالات ومتابعتها.",
    "goal": "مثال: ضمان تطبيق أخلاقيات المهنة وحماية خصوصية بيانات الحالات الطلابية.",
    "quant": "مثال: 100% من ملفات الحالات محفوظة وفق سياسة السرية المعتمدة.",
    "qual": "مثال: لم تُسجَّل أي ملاحظة بخصوص تسريب معلومات حالة طلابية.",
    "reflection": "هل إجراءاتي بحفظ السرية كافية ومطبَّقة بانضباط؟"
  },
  "موجه: التفاعل مع المجتمع المهني": {
    "example": "توثيق مشاركتك كموجه طلابي في اجتماعات الموجهين الطلابيين أو تبادل الخبرات في التعامل مع الحالات.",
    "heading": "وصف المشاركة المهنية",
    "placeholder": "مثال: شاركت في اجتماع الموجهين الطلابيين بالإدارة التعليمية وعرضت آلية متابعتي لحالات التأخر الدراسي.",
    "goal": "مثال: تبادل الخبرات المهنية في التعامل مع الحالات الطلابية مع زملاء المهنة.",
    "quant": "مثال: حضر اللقاء 12 موجهًا وموجهة.",
    "qual": "مثال: استفاد الحضور من آلية المتابعة المعروضة وطلبوا تفاصيلها.",
    "reflection": "هل أسهمت مشاركتي بتطوير ممارسات زملائي بالمهنة؟"
  },
  "موجه: التفاعل مع أولياء الأمور": {
    "example": "توثيق تواصلك كموجه طلابي مع أولياء الأمور حول حالة سلوكية أو نفسية أو اجتماعية تخص أبناءهم.",
    "heading": "وصف التواصل مع أولياء الأمور",
    "placeholder": "مثال: عقدت جلسة مع ولي أمر طالب لديه حالة سلوكية، وأشركته بوضع خطة دعم مشتركة.",
    "goal": "مثال: بناء شراكة فعالة مع الأسرة لدعم الحالة الطلابية بشكل متكامل.",
    "quant": "مثال: 4 جلسات متابعة مع ولي الأمر خلال الشهر.",
    "qual": "مثال: تفاعل ولي الأمر إيجابيًا وطبّق التوصيات بالمنزل.",
    "reflection": "هل إشراك الأسرة كان كافيًا لدعم الحالة؟"
  },

  "محضر: أداء الواجبات الوظيفية": {
    "example": "توثيق التزامك كمحضر مختبر بتطبيق الأنظمة وإجراءات السلامة، والمحافظة على سرية أي معلومات تخص المختبر أو التجارب.",
    "heading": "وصف الإجراء / الالتزام الوظيفي",
    "placeholder": "مثال: التزمت بإجراءات السلامة المهنية عند التعامل مع المواد الكيميائية، وطبّقت تعليمات الوزارة الخاصة بتخزينها.",
    "goal": "مثال: ضمان بيئة مختبر آمنة ومنضبطة وفق الأنظمة المعتمدة.",
    "quant": "مثال: صفر حوادث سلامة بالمختبر خلال الفصل الدراسي.",
    "qual": "مثال: لم تُسجَّل أي ملاحظة إشرافية على إجراءات السلامة بالمختبر.",
    "reflection": "هل إجراءات السلامة المطبَّقة كافية لحماية الطلبة والمعلمين؟"
  },
  "محضر: التفاعل مع المجتمع المهني": {
    "example": "توثيق مشاركتك كمحضر مختبر في دورات أو ورش تخص إدارة المختبرات، وتبادل الخبرات الفنية مع محضرين آخرين.",
    "heading": "وصف المشاركة المهنية",
    "placeholder": "مثال: حضرت ورشة تدريبية عن أساليب حديثة بإدارة المختبرات المدرسية، وطبّقت ما تعلّمته بمختبر مدرستي.",
    "goal": "مثال: تطوير مهاراتي الفنية بإدارة المختبر عبر التعلم المستمر وتبادل الخبرات.",
    "quant": "مثال: حضرت دورة تدريبية واحدة على الأقل خلال الفصل الدراسي.",
    "qual": "مثال: طبّقت فكرتين مستفادتين من الدورة بمختبر مدرستي.",
    "reflection": "هل استفدت عمليًا من هذه المشاركة بتطوير عملي؟"
  },
  "محضر: التفاعل مع أولياء الأمور": {
    "example": "توثيق تواصلك كمحضر مختبر مع أولياء الأمور حول سلامة أبنائهم أثناء التجارب العملية، أو استفسارات تخص المختبر.",
    "heading": "وصف التواصل مع أولياء الأمور",
    "placeholder": "مثال: أوضحت لولي أمر إجراءات السلامة المتبعة بالمختبر بعد استفساره عن تجربة عملية شارك فيها ابنه.",
    "goal": "مثال: طمأنة أولياء الأمور بخصوص سلامة أبنائهم أثناء الأنشطة المخبرية.",
    "quant": "مثال: تم الرد على استفسارين من أولياء الأمور خلال الفصل الدراسي.",
    "qual": "مثال: أعرب ولي الأمر عن ارتياحه بعد توضيح إجراءات السلامة.",
    "reflection": "هل التواصل مع أولياء الأمور بخصوص المختبر كافٍ وواضح؟"
  }
};
...
const DUTY_TYPES = [
  ...
  { value: 'lab_technician', label: 'محضر مختبر' },
];
